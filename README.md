...
- OpenCode's OpenRouter-backed DeepSeek agents require `OPENROUTER_API_KEY` in the environment, for example `export OPENROUTER_API_KEY="your-api-key"` in `~/.config/env.sh`.
